            ...
            <div v-if="mostrar" id="info2">
                <div id="tarjetas" v-for="(pokemon, index) in listaFiltradaDePokemon" :key="index">
                    <div id="mostrarcosas">
                        ...
                        <div id="namei2">
                            <h1 v-for="(item, index) in pokemon.tipo_pk" :key="index" :class="item.toLowerCase()">{{ item }}
                            </h1>
                        </div>
            ...
            <div v-if="mostrardos">
                <div id="nuevacosa">
                    ...
                    <div id="nuevacosa2">
                        ...
                        <p id="info">Especial ataque <input id="barrap" type="text" v-model="specialattack"> {{
                            specialattack }}%</p>
                        <p id="info">Especial defensa <input id="barrap" type="text" v-model="specialdefense"> {{
                            specialdefense }}%
                        </p>
                        <p id="info">Velocidad <input id="barrap" type="text" v-model="speed"> {{ speed }}%</p>
                        <p id="info3" v-for="(item, index) in tipo_pk" :key="index" :class="item.toLowerCase()">{{ item }}
                        </p>
...
#body {
    ...
    margin: 0;
    background-image: url(https://sm.ign.com/ign_latam/review/p/pokemon-le/pokemon-lets-go-pikachu-and-eevee-review_z5w8.jpg);
    background-size: cover;
    /* Ajusta la imagen de fondo para cubrir la ventana del navegador */
